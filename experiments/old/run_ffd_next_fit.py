...
def main() -> None:
    ...
    offline_solver = FirstFitDecreasing(cfg)
    online_policy = NextFitOnlinePolicy(cfg)
    ...
    summary = build_pipeline_summary(
        ...
        online_info,
        offline_method="FFD",
        online_method="NextFit",
    )

    problem = summary["problem"]
    prefix = (
        f"pipeline_ffd_next_fit_N{problem['N']}_"
