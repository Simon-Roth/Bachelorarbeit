...
def main() -> None:
    ...
    offline_solver = CostAwareBestFitDecreasing(cfg)
    ...
    pipeline_name = "CostAwareBFD+CostAwareBestFit"
    summary = build_pipeline_summary(
        ...
        offline_info,
        online_info,
        offline_method="CostAwareBFD",
        online_method="CostAwareBestFit",
    )

    problem = summary["problem"]
    prefix = (
        f"pipeline_costbfd_costbestfit_N{problem['N']}_"
